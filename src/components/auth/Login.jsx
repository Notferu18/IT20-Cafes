    ...
    <div className="min-h-screen bg-solara-light flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        ...
        <div className="mt-4 bg-solara-cream rounded-xl p-4 text-xs text-solara-dark space-y-1">
          <p className="font-bold mb-2">🔑 Test Accounts (after seeding):</p>
          <p>Admin — admin@solara.com / password</p>
          <p>Staff — staff@solara.com / password</p>
          <p>Customer — customer@solara.com / password</p>
        </div>
